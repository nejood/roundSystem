<!--Nadia Ali Bahatheg 5/8/2018

Nadia.bahatheg@gmail.com

this page show the device in class table and allow printing it
-->
<html>
<head>
...
<a href="#print"><img src="../../Admin_img/printer.png" id="printer"></a>
    <br>
<button class="buttons" id="button1" style="float:right; margin-right:10%;" title="back to select another building" onclick="window.location.href = 'showDeviceInfo.php'">Back</button>
<br>

<?php
/*29/7/2018 Nadia Ali Bahatheg*/
...
echo'<table border="1" cellpadding="3" id="printTable" class="table" > 
	<caption ><h2>'.$building_name.' Device Info</h2></caption>
	<br>
<br>
<tr class="tr">
	<td class="td th">Class Num</td>
...
<td class="td th">Note</td>
<td class="td th">Other</td>
</tr>';


	$sql="SELECT * FROM deviceinclass,class where deviceinclass.class_pk=class.class_pk AND building_name='$building_name'";
...
while ($row=mysqli_fetch_assoc($check)) {
	 echo '<tr class="tr">';
	  echo "<td class='td'>" .$row['class_num']."</td>";
