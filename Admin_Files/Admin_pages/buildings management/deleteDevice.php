...
this page allow the user with type:"Admin" to add a device by letting him choose the required building's name from a drop down list then select the required Class's name from a drop down list and choose the device to delete -->
...
<!--link with side menu to avoid repeation of side menu code-->
	...
	<h1 class="titles" id="title1">Delete Device<br>________________
	</h1>
	<!-- end of h1 tag for the page title -->

    <br>

    <!-- start of the form tag for delete a device with confirm msg -->
<form action="deleteDeviceDB.php" method="post" onsubmit="return confirm('Are you sure that you want to delete the '+document.getElementById('device').value+' from this class ?')">
...
<!--label for choose device type from drop down menu-->
 ...
 <select name="deviceType" id="device" class="dropdown" name="deviceType" required>
  ...
  <!--end of device drop down menu-->
	...
	<!-- start of input tag from type button for delete a device -->
	<input type="submit" name="submit" value="Delete" class="buttons" id="button1">
	<!-- end of input tag from type button for delete a device -->
</form><!--end of form-->
...
/*The XMLHttpRequest object can be used to exchange data with a server behind the scenes. This means that it is possible to update parts of a web page, without reloading the whole page.*/
 ...
 //--------------if in class select--------------
  ...
  PHP_V="device.php?B="+str;//send link of select device query
