...
this page allow to insert electronic screen  in deviceinclass table
-->
...
//update the chosen device's data from '' to the entered data
	$sql_com="UPDATE deviceinclass set Escreen='1' where device_pk='$device_pk'";
$check=mysqli_query($conn,$sql_com);

//when the upadate query done successfully 
if(isset($check)){
echo '<script language="javascript">';
echo 'alert("The Electronic screen was added successfully.")';
echo '</script>';
...
//query to insert the class into the deviceinclass table and the entered device info
	$sql_com="INSERT into deviceinclass(class_pk,Escreen) VALUES ('$class_pk','1')";
